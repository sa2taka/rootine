...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/rails/webpacker/blob/v4.0.6/CHANGELOG.md", "source_code_uri" => "https://github.com/rails/webpacker/tree/v4.0.6" } if s.respond_to? :metadata=
